...
\usepackage{syntax,epsfig,endnotes,amsmath,pgf,hyperref,mathpartir,comment,authblk}
...
\begin{table}
\centering
% BEGIN RECEIVE ORGTBL sortreflectprofile
\begin{tabular}{lrl}
Time & Time (\%{}) & Function \\
\hline
...
\end{tabular}
% END RECEIVE ORGTBL sortreflectprofile
\begin{comment}
