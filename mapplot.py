...
def get_data(path):
    return np.transpose(get_lines(path)) / 1000
...
old_data = get_data("oldMapTimes")
static_data = get_data("staticMapTimes")
reflect_data = get_data("reflectMapTimes")
generic_data = get_data("genericMapTimes")
